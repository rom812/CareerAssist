...
This directory contains Terraform configurations for the CareerAssist project.
...
- **`8_enterprise/`** - Enterprise dashboards and monitoring (Guide 8)
...
cd terraform/4_researcher  # (or 3_ingestion, 5_database, etc.)
...
- `CAREER_API_ENDPOINT` - API Gateway endpoint (from Part 3)
- `CAREER_API_KEY` - API key for ingestion (from Part 3)
