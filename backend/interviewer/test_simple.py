...
def test_interviewer():
    ...
    db = Database()
    job_create = JobCreate(clerk_user_id="test_user_001", job_type="interview_prep", request_payload={"test": True})
...
def test_answer_evaluation():
    ...
    test_event = {"type": "answer_evaluation", "question": sample_question, "answer": sample_answer}
