"""
Observability module for LangFuse integration - Interviewer Agent.
...
def observe(
    ...
    agent_name: str = "career-interviewer",
...
def extract_trace_context(event: dict[str, Any]) -> dict[str, str | None]:
